                        ...
                        <ul>
                            <li class="fileds">
                                <div class="name_fileds">
                                    ...
                                    <input name="firstname" id="firstname" type="text" onblur="firstname(this.value)" value="<?php echo $first;?>">
...
//                                    }?>
                                ...
                                <div class="name_fileds">
                                    ...
                                    <input name="lastname" type="text"  id="lastname" onblur="lastName(this.value)"value="<?php echo $last;?>">
                                    <!--lastname validation-->
                                    <?=$lastname_error?>
...
//                                    ?>
                            ...
                            <li class="fileds">
                                <div class="phone_fileds">
                                    ...
                                    <input name="phone" type="number"  id="phone" onblur="Phone(this.value)"  value="<?php echo $phone;?>">
                                    <!--lastname validation-->
                                    <?=$phone_error?>
...
//                                    ?>
                                ...
                                <div class="phone_fileds">
                                    ...
                                    <input name="office" type="number" value="<?php echo $office;?>">
                                </div>
                            </li>
                            <li class="fileds">
                                <div class="email_fileds">
                                    <label>Email</label>
                                    <input name="email" type="email"  onblur="emailval(this.value)" value="<?php echo $email;?>">
                                    <?=$email_error?>
<!--                                    --><?php
...
//                                        ?>
                            ...
                            <li class="fileds">
                                <div class="pass_fileds">
                                    ...
                                    <input name="password" type="password"  id="password"  onblur="passWord(this.value)" value="<?php echo $password;?>">
                                    <?=$password_error?>
<!--                                    --><?php
...
//                                    ?>
                                ...
                                <div class="pass_fileds">
                                    ...
                                    <input name="compass" type="password"  id="compass"  onblur="comPass(this.value)"  value="<?php echo $compass;?>">
                                    <?=$compass_error?>
                                    <?php
                            ...
                            <li class="fileds">
                                <div class="dob_fileds selectbox">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <select name="day" class="select day" onblur="dt(this.value)" required id="day" value="<?php echo $first;?>">
                                        ...
                                        <li>
                                            <select name="year" class="select year" id='year' required onclick="years(this.value)" value="<?php echo $first;?>">
                                ...
                                <div class="age_fileds">
                                    <label>Age</label>
                                    <input name="age" id="age" type="text"   value="<?php echo $age;?>">
                                    <?=$age_error?>
                              <?php
...
//                                    ?>
                            ...
                            <li>
                                <div class="pincode_fileds">
                                    <label>Pincode</label>
                                    <input name="pincode" type="number"  id="pincode" onblur="code(this.value)">
                                    <?=$pin_error?>
...
//                                    ?>
                        ...
                        <div class="next_btn_block">
                            <div class="next_btn">
                                ...
                                <input type="SUBMIT" name="SUBMIT" style="display:inline; text-align: center;    margin-left: 100px;border-radius: 5px;;  font-family: 'roboto_slablight';width: 150px; height: 50px;background-color: #9fbc35 " type="button" value="submit">
