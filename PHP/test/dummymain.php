...
<form action="<?php $_SERVER['PHP_SELF']?>"
    <div id="wrapper">
      ...
      $reslt =mysqli_query($conn, "select * from `customer` ORDER  BY  `$sortof` $sortby  LIMIT $start, $perpage");
       ...
       // var_dump($reslt);
        ...
        if($rows){
            echo $rows;
            $i = 0;
            while($post = mysqli_fetch_array($reslt))
                ...
                <div class="filable_form_container">
                    ...
                    <div class="table_container_block">
                        ...
                        <tr>
                            ...
                            <th style='width:12%'>Name <a href='dummymain.php?sortby=desc&sortof=first_name' class='sort_icon'><img src='Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/sort.png'></a></th>
                            <th>Email<a href='dummymain.php?sortby=desc&sortof=email' class='sort_icon'><img src='Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/sort.png'></a></th>
                            <th>Phone<a href='dummymain.php?sortby=desc&sortof=phone_no' class='sort_icon'><img src='Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/sort.png'></a></th>
                            <th>Gender<a href='dummymain.php?sortby=desc&sortof=gender' class='sort_icon'><img src='Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/sort.png'></a></th>
                            <th>Pincode<a href='dummymain.php?sortby=desc&sortof=pincode' class='sort_icon'><img src='Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/sort.png'></a></th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>";?>
                    ...
                    <div class="pagination_listing">
                        ...
                        echo "<ul>";
                            ...
                            {
                                $j = $page - 1;
                                 echo "<li><a id='page_a_link' href='dummymain.php?page=$j'>< Prev</a></li>";
                            }
...

                            {
...

                                {
                                    ...
                                    echo "<li><a id='page_a_link' href='dummymain.php?page=$i'>$i</a></li>";
...

                            {
                                ...
                                $j = $page + 1;
                                  ...
                                  echo "<li><a id='page_a_link' href='dummymain.php?page=$j'>Next</a></li>";
