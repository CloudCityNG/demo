                        ...
                        <tr>
                            ...
                            <td>
                                <div class="">
                                    ...
                                    <form style="display: inline" action="delete.php?id=<?php echo $value['id']?>" method="post">
                                    <button style="display: inline" class="btn btn_edit">Edit</button>

                                    </form>

                                    <form style="display: inline" action="Edit.php?id=<?php echo $value['id']?>" method="post">
