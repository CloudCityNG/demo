...
<!--            --><?php //echo "$display_output";?>
    ...
    <?php echo form_open('Practice/insert'); ?>
                        ...
                        <ul>
                            <li class="fileds">
                                <div class="name_fileds">
                                    ...
                                    <input name="firstname" id="firstname" type="text" value="<?php if(isset($cut)){echo $cut['first'];}else{echo "";}?>">
                                </div>

                                <div class="name_fileds">
                                    <label>Last Name</label>
                                    <input name="lastname" type="text"  id="lastname" value="<?php if(isset($cut)){echo $cut['last'];}else{echo "";}?>">
                                 </div>
                            ...
                            <li class="fileds">
                                <div class="phone_fileds">
                                    ...
                                    <input name="phone" type="number"  id="phone" value="<?php if(isset($cut)){echo $cut['phone'];}else{echo "";}?>">
                                </div>
                                <div class="phone_fileds">
                                    <label>Office No</label>
                                    <input name="office" type="number" value="<?php if(isset($cut)){echo $cut['office'];}else{echo "";}?>">
                                </div>
                                <div style="display:inline">
                            ...
                            <li class="fileds">
                                <div class="pass_fileds">
                                    ...
                                    <input name="password" type="password"  id="password" value="<?php if(isset($cut)){echo $cut['password'];}else{echo "";}?>">
                                    <div style="display:inline">
                                ...
                                <div class="pass_fileds">
                                    ...
                                    <input name="compass" type="password"  id="compass" value="<?php if(isset($cut)){echo $cut['compass'];}else{echo "";}?>">
                                    <div style="display:inline">
...
<!--                                            --><?//=$year_error?>
                                ...
                                <div class="age_fileds">
                                    <label>Age</label>
                                    <input name="age" id="age" type="text"  value="<?php if(isset($cut)){echo $cut['age'];}else{echo "";}?>" >
                                    <div style="display:inline">
                            ...
                            <li>
                                <div class="pincode_fileds">
                                    <label>Pincode</label>
                                    <input name="pincode" type="number"  id="pincode" value="<?php if(isset($cut)){echo $cut['pincode'];}else{echo "";}?>">
                                    <div style="display:inline">
                        ...
                        <div class="next_btn_block">
                            <div class="next_btn">
                                ...
                                <a href="<?php echo site_url('Practice/index')?>" style="display:inline;text-align: center; width: 200px; height: 100px;margin-left: 100px; padding: 14px border-radius: 5px;;  font-family: 'roboto_slablight';width: 150px; height: 50px; "> Back</a>

                                <input type="submit" name="Submit" style="display:inline;text-align: center;    margin-left: 100px;border-radius: 5px;;  font-family: 'roboto_slablight';width: 150px; height: 50px;background-color: #9fbc35 " type="SUBMIT" value="Submit">
                                ...
                                <?php echo form_close(); ?> <!--<a href="http://wireframes.php-dev.in/training/php/assignment/partners_preference_form.html">Submit  <span><img src="Vital%20Partners%20Leading%20Dating%20and%20Introduction%20Agency%20in%20Sydney%20&amp;%20Canberra_files/small_triangle.png" alt="small_triangle"> </span></a>-->
                            </div>
                        </div>
                    </div>
                </div>
