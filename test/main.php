    ...
    $type=(isset($_GET['type'])&&!empty($_GET['type'])?$_GET['type']:"view_all");
        ...
        switch ($type)
        {
            case "search" :
                ...
                {
                    $ser = $_GET['keyword'];
                    $search_name = "SELECT * FROM `customer` WHERE `first_name` LIKE '%$ser%' OR `email` LIKE '%$ser%' OR `phone_no` LIKE '%$ser%' OR `gender` LIKE '%$ser%' OR `pincode` LIKE '%$ser%'";
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="">
                                    <form></form>
                                    <form  onclick="return delete_con()" action="delete.php?id=<?php echo $value['id']?>" method="post">
