            ...
            <div class="span12">
                ...
                <form action="<?php echo site_url('admin/category/insert_category')?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <input class="span6 m-wrap"  style=" display: inline;width:220px;"type="text" placeholder="Category_name" name="category_name" value="<?php echo set_value('category_name')?>"/>
                    </div>
