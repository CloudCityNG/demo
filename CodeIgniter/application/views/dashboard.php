                ...
                <div class="row-fluid">
                    <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                        <div class="dashboard-stat blue">
                            ...
                            <a class="more" href="<?php echo base_url('admin/adminuser/')?>">
                    ...
                    <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                        <div class="dashboard-stat green">
                            ...
                            <a class="more" href="<?php echo base_url('admin/product/')?>">
                                View more <i class="m-icon-swapright m-icon-white"></i>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <ul class="chats">
                                        <li class="in">
                                            ...
                                            <div class="message">
                                                ...
                                                <a href="#" class="name"><?php echo $this->session->userdata('id');
                                                     echo $this->session->userdata('id')?></a>
