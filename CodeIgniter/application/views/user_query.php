...
<!--                        <span class="username">--><?PHP //echo $this->session->userdata('session')?><!--</span>-->
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="">
                ...
                <ul class="sub-menu">
                    <li >
                        <a href="<?php echo base_url('layout_horizontal_sidebar_menu.html')?>">
                            Horzontal & Sidebar Menu</a>
                    </li>
                    <li >
                        <a href="<?php echo base_url('layout_horizontal_sidebar_menu1.html')?>">
                            Horzontal Menu 1</a>
                    </li>
                    <li >
                        <a href="<?php echo base_url('layout_horizontal_sidebar_menu2.html')?>">
                            Horzontal Menu 2</a>
                    </li>
                    <li >
                        <a href="<?php echo base_url('layout_promo.html')?>">
                            Promo Page</a>
                    </li>
                    <li >
                        <a href="<?php echo base_url('layout_email.html')?>">
                            Email Templates</a>
                    </li>
                    <li >
                        <a href="<?php echo base_url('layout_ajax.html')?>">
