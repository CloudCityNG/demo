                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li ><a href="<?php if(!empty($data)){echo site_url('Useraccount/address_update/');}else{echo site_url('Userlogin/login');}?>">Address Book</a>
                            ...
                            <li><a href="<?php  if(!empty($data)){echo site_url('Useraccount/password_change/');}else{echo site_url('Userlogin/login');}?>">Change Password<i></i></a>
                               <!-- <ul role="menu" class="sub-menu">
...
<!--                    <center><h1>1- - - -    2- - - -3- - - -4</h1>-->
<!--                                <h5>Shipped- - >   Processed- - > Processing- - > Completed</h5></center>-->
...
<!--                        <h5>Shipped- - >   Processed- - > Processing- - > Completed</h5></center>-->
                    ...
                    <form action="<?php echo site_url('Useraccount/login_order')?>" method="post">
