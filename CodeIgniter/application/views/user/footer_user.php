            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p><a href="<?php echo base_url('home/newsletter')?>"><img src="<?php echo base_url('images/newsletter-image.jpg')?>" style="width:200px;height: 75px" alt="" /></a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Designed by <span><a target="_blank" href="<?php echo base_url('http://www.themeum.com')?>">Themeum</a></span></p>
            </div>
        </div>
    </div>
