...
<script src="<?php echo base_url('js/checkout_register_validation.js')?>"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 clearfix">
                    <div class="bill-to">
                        <p>Bill To</p>
                        <div class="form-one">
                            <form name="form" onsubmit="return submit_registerform()" action="<?php echo site_url('products/product_data')?>" method="post">

                                <input name="user_name" value="<?php if(!empty($userdata)){echo $item['user_name'];}else{echo set_value('user_name');}?>" type="text" placeholder="First Name">
                                ...
                                <input onchange="return email()" name="user_email" id="mail" value="<?php if(!empty($userdata)){echo $item['user_email'];}else{echo set_value('user_email');}?>" type="text" placeholder="Email*">
