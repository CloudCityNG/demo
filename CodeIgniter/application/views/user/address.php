...
<a href="<?php echo base_url('useraccount/new_address/'.$data)?>" type="submit" style="margin-left: 125px;display:inline; margin-top: 00%" class="btn btn-default col-sm-4">Add New Address</a>
<?php //var_dump($address_all); ?>
...
<!--                                    <a href="--><?php //echo site_url('useraccount/delete_address'.$value['address_id']);?><!--" class="btn btn-default add-to-cart"><i class="fa fa-delete"></i>Delete</a>-->
                                </div>
                                <div>
                                </div>
                            </div>
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a onclick="return delete_con()" href="<?php echo site_url('useraccount/delete_newaddress/'.$value['address_id'])?>"><i class="fa fa-minus-square"></i>Delete</a></li>
                                    <li><a href="<?php echo site_url('useraccount/update_newaddress/'.$value['address_id'])?>"><i class="fa fa-plus-square"></i>Update</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    {
        alert('hello');
        var code=document.getElementById('select').value;
        alert(code);
        $.ajax({ url: '<?php echo site_url('useraccount/user_alladderss');?>',
            data: {code: code},
            type: 'post',
