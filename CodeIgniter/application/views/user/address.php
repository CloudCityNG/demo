        ...
        <div class="row">
            <div class="col-sm-8 ">
                <div class="login-form"><!--login form-->
                    ...
                    <form action="<?php echo site_url('UserControl/change_address')?>" method="post">

                        <h2>Your Address</h2>
                        <input type="hidden" name="user_id" value="<?php echo $data?>">
                        <input type="text" placeholder="Address_1" name="address_1"value="<?php echo $value['address_1']?>"/>
                        <div style="display:inline; color: red" >
                            <?php echo form_error('address_1'); ?>
                        </div>
                        <input type="text" placeholder="Address_2" name="address_2"value="<?php echo $value['address_2']?>"/>
                        <div style="display:inline; color: red" >
                            <?php echo form_error('address_2'); ?>
                        </div>
                        <input type="text" placeholder="City" name="city"value="<?php echo $value['city']?>"/>
                        <div style="display:inline; color: red" >
                            <?php echo form_error('city'); ?>
                        </div>
                        <input type="text" placeholder="State" name="state"value="<?php echo $value['state']?>"/>
                        <div style="display:inline; color: red" >
                            <?php echo form_error('state'); ?>
                        </div>
                        <input type="text" placeholder="Country" name="country"value="<?php echo $value['country']?>"/>
                        <div style="display:inline; color: red" >
                            <?php echo form_error('country'); ?>
                        </div>
                        <input type="text" placeholder="Zipcode" name="zipcode"value="<?php echo $value['zipcode']?>"/>
                        <div style="display:inline; color: red" >
