        ...
        <div class="row">
            <div class="col-sm-8 ">
                <div class="login-form"><!--login form-->
                    <center><h4><b>Order Details</b></h4>
                    <table class="table table-bordered" style="align-items: center" width="600px">
                        <tr>
                            <th>Order ID</th>
                            <th>Product Name</th>
                            <th>Status</th>
                    ...
                    <b style="margin-left: 430px">Total Amount =
                    <?php echo $value['grand_total']?></b>
