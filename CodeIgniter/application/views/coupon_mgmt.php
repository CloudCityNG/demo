            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body">
                        <!--                            <div class="clearfix">-->
                        <div class="btn-group">
                            <a href="<?php echo base_url('admin/coupon/add_coupon');?>" id="sample_editable_1_new" class="btn green">
                            ...
                            if(empty($coupon)){
                                ...
                                {$value = (array) $value;
                                    ...
                                    <tr>
                                        ...
                                        <td><a onclick="return delete_con()" href="<?php echo site_url('admin/coupon/delete_coupon/'.$value['coupon_id']);?>">Delete</a></td>
                                    </tr>
                                <?php } } ?>
                        </table>
                    </div>
